    ...
    <div id="navbar-container" class="boxed">
        ...
        <div class="navbar-header">
            <a href="index.html" class="navbar-brand">
                <img src="/assets/picture/logo.png" alt="Nifty Logo" class="brand-icon">
                <div class="brand-title">
                    <span class="brand-text">大决策后台管理系统</span>
                </div>
            </a>
        </div>
        <!--================================-->
                            ...
                            <div class="nano-content">
                                <ul class="head-list">
                                    ...
                                    <li class="bg-gray">
                                        <a class="media" href="#">
                                            <div class="media-left">
                                                <img class="img-circle img-sm" alt="Profile Picture" src="/assets/picture/9.png">
                                            </div>
                                            <div class="media-body">
                                    ...
                                    <li class="bg-gray">
                                        <a class="media" href="#">
                                            <div class="media-left">
                                                <img class="img-circle img-sm" alt="Profile Picture" src="/assets/picture/3.png">
                                            </div>
                                            <div class="media-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-3">
                                ...
                                <ul class="list-unstyled list-inline text-justify">
                                    ...
                                    <li class="pad-btm">
                                        <img src="/assets/picture/mega-menu-2.jpg" alt="thumbs">
                                    </li>
                                    <li class="pad-btm">
                                        <img src="/assets/picture/mega-menu-3.jpg" alt="thumbs">
                                    </li>
                                    <li class="pad-btm">
                                        <img src="/assets/picture/mega-menu-1.jpg" alt="thumbs">
                                    </li>
                                    <li class="pad-btm">
                                        <img src="/assets/picture/mega-menu-4.jpg" alt="thumbs">
                                    </li>
                                    <li class="pad-btm">
                                        <img src="/assets/picture/mega-menu-5.jpg" alt="thumbs">
                                    </li>
                                    <li class="pad-btm">
                                        <img src="/assets/picture/mega-menu-6.jpg" alt="thumbs">
                                    </li>
                                </ul>
                ...
                <li class="dropdown">
                    <a id="demo-lang-switch" class="lang-selector dropdown-toggle" href="#" data-toggle="dropdown">
                                <span class="lang-selected">
                                    <img class="lang-flag" src="/assets/picture/united-kingdom.png" alt="English">
                                </span>
                    </a>
                    ...
                    <ul class="head-list dropdown-menu">
                        ...
                        <li>
                            <!--France-->
                            <a href="#">
                                <img class="lang-flag" src="/assets/picture/france.png" alt="France">
                        ...
                        <li>
                            <!--Germany-->
                            <a href="#">
                                <img class="lang-flag" src="/assets/picture/germany.png" alt="Germany">
                        ...
                        <li>
                            <!--Italy-->
                            <a href="#">
                                <img class="lang-flag" src="/assets/picture/italy.png" alt="Italy">
                        ...
                        <li>
                            <!--Spain-->
                            <a href="#">
                                <img class="lang-flag" src="/assets/picture/spain.png" alt="Spain">
                ...
                <li id="dropdown-user" class="dropdown">
                    <a href="#" data-toggle="dropdown" class="dropdown-toggle text-right">
                                <span class="pull-right">
                                    <!--<img class="img-circle img-user media-object" src="/assets/picture/24agall_big.png" alt="Profile Picture">-->
                                    <i class="demo-pli-male ic-user"></i>
                                </span>
                        <div class="username hidden-xs">${loginUser.realName}</div>
                    </a>
...
<nav id="mainnav-container">
    <div id="mainnav">
                ...
                <div class="nano-content">
                    ...
                    <div id="mainnav-profile" class="mainnav-profile">
                        <div class="profile-wrap">
                            <div class="pad-btm">
                                ...
                                <img class="img-circle img-sm img-border"
                                     src="${loginUser.headImg==null?'/assets/picture/1.png':loginUser.headImg}" alt="Profile Picture">
                            </div>
                            <a href="#profile-nav" class="box-block" data-toggle="collapse" aria-expanded="false">
                                            <span class="pull-right dropdown-toggle">
                                                <i class="dropdown-caret"></i>
                                            </span>
                                <p class="mnp-name">${loginUser.realName}</p>
                            </a>
                        </div>
                        <div id="profile-nav" class="collapse list-group bg-trans">
                            ...
                            <a href="javascript:;" onclick="turnpage('/main/update_password')" class="list-group-item">
                                <i class="demo-pli-information icon-lg icon-fw"></i> 修改密码
                            </a>
                    ...
                    <ul id="mainnav-menu" class="list-group">
                        ...
                        <!--Category name-->
                        <li class="list-header">用户中心</li>

                        <!--Menu list item-->
                        <li>
                            <a href="#">
                                <i class="demo-psi-boot-2"></i>
                                <span class="menu-title">老师管理</span>
                                <i class="arrow"></i>
                            </a>

                            <!--Submenu-->
                            <ul class="collapse">
                                <li class=""><a href="/employee/list">老师列表</a></li>
                            </ul>
                        </li>
                        ...
                        <li>
                            <a href="#">
                                ...
                                <span class="menu-title">日常管理</span>
                                <i class="arrow"></i>
                            </a>
                            <!--Submenu-->
                            <ul class="collapse">
                                <li class=""><a href="/column/list">栏目列表</a></li>
                                <li class=""><a href="/operating_record/customer_list">操作客户</a></li>
                                <li class=""><a href="/operating_log/list">操作日志</a></li>
                                <li class=""><a href="/jie_pan/list">名师解盘</a></li>
                                <li class=""><a href="/researchResult/list">研究成果</a></li>
                                <li class=""><a href="/leave_words/list">客户留言</a></li>
                            </ul>
                        </li>
                        ...
                        <li>
                            ...
                            <!--Submenu-->
                            <ul class="collapse">
                                <li class=""><a href="/permission/list">权限管理</a></li>
                                <li class=""><a href="/role/list">角色管理</a></li>
                                <li class=""><a href="/menu/list">菜单管理</a></li>
                            </ul>
                        </li>
                        <!--Menu list item-->
                        <li>
                            ...
                            <!--Submenu-->
                            <ul class="collapse">
                                <li class=""><a href="/customer/list">客户列表</a></li>
                                <li class=""><a href="/complain/list">投诉记录</a></li>
                                <li class=""><a href="/complain/day_count">投诉统计</a></li>
                            </ul>
                        </li>
                        ...
                        <li>
                            ...
                            <ul class="collapse">
                                <li class="">
                                     <li class=""><a href="/article/list">文章列表</a></li>
                                </li>
                        ...
                        <li>
                            ...
                            <!--Submenu-->
                            <ul class="collapse">
                                <li class=""><a href="/video/list">视频列表</a></li>
                            </ul>
                        </li>
                        ...
                        <li>
                            ...
                            <!--Submenu-->
                            <ul class="collapse">
                                <li class=""><a href="/workFlow/processDefinition/index">部署流程</a></li>
                                <li class=""><a href="/workFlow/personalTask/index">任务办理</a></li>
                            </ul>
                        </li>
                        ...
                        <a href="/video/edit">
                                ...
                                <span class="menu-title">视频发布</span>
                            </a>
                        </li>
                        ...
                        <!--Category name-->
                        <li class="list-header">推广设置</li>

                        <!--Menu list item-->
                        <li>
                            <a href="#">
                                <i class="demo-psi-repair"></i>
                                <span class="menu-title">推广</span>
                                <i class="arrow"></i>
                            </a>

                            <!--Submenu-->
                            <ul class="collapse">
                                <li><a href="misc-timeline.html">推广老师</a></li>
                                <li><a href="misc-calendar.html">Banner</a></li>
                                <li><a href="misc-maps.html">头条</a></li>
                                <li><a href="misc-maps.html">推广链接</a></li>
                            </ul>
                        </li>
                        ...
                        <li>
                            ...
                            <!--Submenu-->
                            <ul class="collapse">
                                <li><a href="icons-ionicons.html">专属客服</a></li>
        ...
        <!--End menu-->
        <!-- iframe部分 -->
       <%-- <iframe src="/login/right" id="rightIframe" frameborder="0"
                scrolling="no" marginheight="0" marginwidth="0" name="view_frame"
        ...
        <script type="text/javascript">
            function autoHeight() {
                ...
                if (iframe.Document) {//ie自有属性
                    ...
                    iframe.width = screen.width- $("#mainnav-menu-wrap").width() - 20;
                }
            }
        </script>--%>
        <!-- iframe部分结束 -->
