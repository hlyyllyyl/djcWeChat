                                                ...
                                                <div class="table-responsive">
                                                    <table id="myTable" class="table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                                        ...
                                                        <tr role="row">
                                                            ...
                                                            <th  rowspan="1" colspan="1" >权限名称</th>
                                                            <th  rowspan="1" colspan="1" >权限描述</th>
                                                            <th  rowspan="1" colspan="1" >权限地址</th>
                                                            <th  rowspan="1" colspan="1" >权限</th>
                                                            <th  rowspan="1" colspan="1" >权限菜单</th>
                                                        </thead>
                                                        <tbody>
...
<script type="text/javascript">
    $(function() {
        ...
        $("#myTable tr td").dblclick(function() {
            ...
            $("#modelInfo").modal();
            $("#modelInfo .modal-body").load("/permission/edit?id="+id);
        ...
        $('#demo-dt-addrow-btn').click( function () {
            $("#modelInfo .modal-body").load("/permission/edit");
        ...
        $('#demo-dt-delete-btn').click( function () {
            ...
            if(confirmdel){
                //开始请求删除
                $.ajax({
                    url:'/permission/select_del',
                    data:JSON.stringify(booksid),
                    type:'post',
                    success:function(result){
                        if(result.success){
                            alert("删除成功");
                            goUrl("/permission/list");
                        }else{
                            alert("删除失败");
                        }
                    }
