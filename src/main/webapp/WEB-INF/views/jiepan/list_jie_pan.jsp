        ...
        <div class="mainbox">
            <div class="boxed">
                ...
                <div id="content-container">
                    ...
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <div id="page-title">
                        <h1 class="page-header text-overflow">名师解盘</h1>
                    </div>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End page title-->
                                                ...
                                                <div class="table-responsive">
                                                    <table id="myTable" class="table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                                        ...
                                                        <tr role="row">
                                                            ...
                                                            <th  rowspan="1" colspan="1" >解盘内容</th>
                                                            <th  rowspan="1" colspan="1" >是否置顶</th>
                                                        </thead>
                                                        <tbody>
                                                        <c:forEach items="${jiePanList}" var="item">
                                                            <tr id="${item.id}">
                                                                <td class="center">
                                                                    <div>
...
<script type="text/javascript">
    $(function() {
        $("#query").click(function () {
            goUrl('/jie_pan/list'+'?'+$('#domainForm').serialize());
        });
        ...
        $("#myTable tr td").dblclick(function() {
            ...
            $("#modelInfo").modal();
            $("#modelInfo .modal-body").load("/jie_pan/edit?id="+id);
        ...
        $('#demo-dt-addrow-btn').click( function () {
            $("#modelInfo .modal-body").load("/jie_pan/edit");
