                                                ...
                                                <div class="table-responsive">
                                                    <table id="myTable" class="table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                                        ...
                                                        <tr role="row">
                                                            ...
                                                            <th  rowspan="1" colspan="1" >角色标识</th>
                                                            <th  rowspan="1" colspan="1" >角色权限</th>
                                                        </thead>
                                                        <tbody>
                                                        <c:forEach items="${roleList}" var="item">
                                                            <tr id="${item.id}">
                                                                ...
                                                                <td>${item.sn}</td>
                                                                <td>
                                                                    <c:forEach items="${item.permissions}" var="items">
                                                                        ${items.name}
                                                                    </c:forEach>
                                                                </td>
                                                                </td>
...
<script type="text/javascript">
    $(function() {
        $("#query").click(function () {
            goUrl('/role/list'+'?'+$('#domainForm').serialize());
        });
        ...
        $("#myTable tr td").dblclick(function() {
            ...
            $("#modelInfo").modal();
            $("#modelInfo .modal-body").load("/role/edit?id="+id);
        ...
        $('#demo-dt-addrow-btn').click( function () {
            $("#modelInfo .modal-body").load("/role/edit");
