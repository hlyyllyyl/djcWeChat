                                                ...
                                                <div class="table-responsive">
                                                    <table id="myTable" class="table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                                        ...
                                                        <tr role="row">
                                                            ...
                                                            <th  rowspan="1" colspan="1" >菜单编号</th>
                                                            <th  rowspan="1" colspan="1" >菜单名称</th>
                                                            <th  rowspan="1" colspan="1" >图标</th>
                                                            <th  rowspan="1" colspan="1" >地址</th>
                                                            <th  rowspan="1" colspan="1" >简介</th>
                                                            <th  rowspan="1" colspan="1" >父菜单</th>
                                                        </thead>
                                                        <tbody>
                                                        <c:forEach items="${systemMenuList}" var="item">
                                                            <tr id="${item.id}">
                                                                <td class="center">
                                                                    <div>
...
<script type="text/javascript">
    $(function() {
        $("#query").click(function () {
            goUrl('/menu/list'+'?'+$('#domainForm').serialize());
        });
        ...
        $("#myTable tr td").dblclick(function() {
            ...
            $("#modelInfo").modal();
            $("#modelInfo .modal-body").load("/menu/edit?id="+id);
        ...
        $('#demo-dt-addrow-btn').click( function () {
            $("#modelInfo .modal-body").load("/menu/edit");
