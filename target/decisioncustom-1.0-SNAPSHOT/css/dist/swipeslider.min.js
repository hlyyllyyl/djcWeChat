!(function(n) {
  n.fn.swipeslider = function(i) {
    ...
    function E() {
      B.after('<span class="sw-next-prev sw-prev" style="display:none;"></span>'),
        D.find(".sw-prev").click(function() {
          L && (l(), w(), a());
        }),
        B.after('<span class="sw-next-prev sw-next" style="display:none;"></span>'),
    ...
    return (
      (function() {
        n(D).css("padding-top", F.sliderHeight),
          ...
          n(window).resize(t),
          F.prevNextButtons && E(),
          B.find(".sw-slide:last-child")
            .clone()
            .prependTo(B),
          B.find(".sw-slide:nth-child(2)")
            .clone()
            .appendTo(B),
