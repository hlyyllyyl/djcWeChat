            ...
            <div id="page-content">
                ...
                <div class="panel">
                    <div class="panel-heading">
                        <h3 class="panel-title">机构情报列表</h3>
                    </div>
                    <div class="panel-body">
                        <div id="demo-dt-basic_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                            ...
                            <tr role="row">
                                ...
                                <th class="min-desktop sorting" tabindex="0" aria-controls="demo-dt-basic" rowspan="1" colspan="1" style="width: 132px;" aria-label="Start date: activate to sort column ascending">是否置顶</th>
                            ...
                            <tbody>
                            <c:forEach items="${intelligenceAgenciesList}" var="item">
                            <tr>
                                <td class="center">
                                    <div>
                                ...
                                <td>
                                    ...
                                    <button type="button" onClick="intelligenceAgenciesDel(${item.textId})" class="btn btn-dark btn-rounded">删除</button>
                                </td>
                            </tr>
                            </c:forEach>
                            </tbody>
