                ...
                <li id="dropdown-user" class="dropdown">
                    <a href="#" data-toggle="dropdown" class="dropdown-toggle text-right">
                                <span class="pull-right">
                                    <!--<img class="img-circle img-user media-object" src="/assets/picture/1.png" alt="Profile Picture">-->
                ...
                <div class="nano-content">
                    ...
                    <div id="mainnav-profile" class="mainnav-profile">
                        <div class="profile-wrap">
                            <div class="pad-btm">
                                <span class="label label-success pull-right">New</span>
                                <img class="img-circle img-sm img-border" src="/assets/picture/1.png" alt="Profile Picture">
                            </div>
                    ...
                    <ul id="mainnav-menu" class="list-group">
                        ...
                        <li>
                            ...
                            <!--Submenu-->
                            <ul class="collapse">
                                <li><a href="javascript:;" onclick="turnpage('/user/list')">用户列表</a></li>
                                <li><a href="javascript:;" onclick="turnpage('/user/getTeachers')">老师列表</a></li>
                            </ul>
                        </li>
                        ...
                        <li>
                            ...
                            <!--Submenu-->
                            <ul class="collapse">
                                <li><a href="/login/tableStatic">操作记录</a></li>
                                <li><a href="/login/table">操作日志</a></li>
                                <li><a href="javascript:;" onclick="turnpage('/researchResult/list')">研究成果</a></li>
                            </ul>
                        </li>
                        ...
                        <li>
                            <a href="#">
                                ...
                                <span class="menu-title">机构情报</span>
                                <i class="arrow"></i>
                            </a>

                            <!--Submenu-->
                            <ul class="collapse">
                                <li><a href="javascript:;" onclick="turnpage('/intelligenceAgencies/list')">机构情报</a></li>
                            </ul>
                        </li>
                        <!--Menu list item-->
                        <li>
                            <a href="#">
                                ...
                                <span class="menu-title">榜单</span>
                                <i class="arrow"></i>
                            </a>

                            <!--Submenu-->
                            <ul class="collapse">
                                <li><a href="forms-general.html">最新榜单</a></li>
                            </ul>
                        </li>
                        <!--Menu list item-->
                        <li>
                            <a href="javascript:;" onclick="turnpage('/text/edit')">
