...
<div class="panel">
    ...
    <table id="baseInfo" width="100%" align="center" class="list" border="0"
        ...
        <div class="form-group">
            <label class="col-md-3 control-label" for="demo-text-input">老师姓名</label>
            <div class="col-md-9">
                <sf:input type="text" id="demo-text-input"  class="form-control" placeholder="" path="userName"/>
                <small class="help-block">请输入老师姓名</small>
            </div>
        </div>
        ...
        <div class="form-group">
            <label class="col-md-3 control-label" for="demo-textarea-input">老师简介</label>
            <div class="col-md-9">
                <textarea id="demo-textarea-input" rows="9" class="form-control" placeholder="请输入老师简介内容.."></textarea>
            </div>
        </div>
        <div class="form-group">
